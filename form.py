...
<head>
  ...
  <title>Unauthorized Leave Form</title>
</head>
<body>
      ...
      <div class="leave-form">
        ...
        <form name="loginform" onsubmit="return login()" onchange="remdays();">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" id="start-date" name="form" oninput="calculateDays()">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="result" rows="3" placeholder="No.of.Days" name="days" readonly></textarea>
          </div>            
