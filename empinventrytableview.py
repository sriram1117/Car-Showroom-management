...
print("""
             ...
             """)
print("""
                                    <a href="./empleaveform.py?id=%s" class="nav-link px-0"> </i> <span class="d-none d-sm-inline">NEW</span>
             """% (pid))
print("""
                                        </a>
                                </li>
             ...
             """)
print("""
                                    <a href="./empleavedataview.py?id=%s" class="nav-link px-0"> <i class="fas fa-backspace"> <span class="d-none d-sm-inline">EXIST</span>
             """% (pid))
print("""
                                        </a>
                                </li>
