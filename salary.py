...
print("""
<table border="4" style="margin-left:250px;margin-top:10px;align:center;width:1000px;" cellpadding="0" cellspacing="0">
<tr>
<th>emp_id</th>
<th>name</th>
<th>role</th>
...
for i in res:
    ...
    print("""
    <td>
    <a href="./salarycalculation.py?id=%s"><button>Calculate Salary</button></a>
    </td>
    </tr>
    """% i[0])
print("""
